...
public class PANEL_USUARIO extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtreporteEstudiante = new javax.swing.JButton();
        ...
        txtreporteEstudiante.setText("Reporte Estudiante");
        txtreporteEstudiante.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtreporteEstudianteActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtreporteEstudiante)))))
    ...
    private void txtreporteEstudianteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtreporteEstudianteActionPerformed
        // TODO add your handling code here:
    ...
    System.out.println("Identificación ingresada: " + identificacion);
    ...
    try {
        ...
        // Cargar el reporte
        JasperReport report = JasperCompileManager.compileReport("src/reportes/report3.jrxml");

        // Crear los parámetros
        Map<String, Object> parameters = new HashMap<>();
        parameters.put("identificacion", identificacion);

        System.out.println("Parámetro pasado: " + parameters.get("identificacion"));

        // Llenar el reporte con datos
        JasperPrint jasperPrint = JasperFillManager.fillReport(report, parameters, conn);

        // Verificar si el reporte tiene páginas
        if (jasperPrint.getPages().isEmpty()) {
            System.out.println("No se encontraron resultados para la identificación: " + identificacion);
            JOptionPane.showMessageDialog(this, "El documento no tiene páginas.");
        } else {
            // Mostrar el reporte
    ...
    }//GEN-LAST:event_txtreporteEstudianteActionPerformed
    ...
    private javax.swing.JButton txtreporteEstudiante;
